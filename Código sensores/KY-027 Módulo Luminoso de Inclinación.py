...
MQTT_BROKER = "192.168.137.164"  # Cambia a la IP de tu broker MQTT
MQTT_PORT = 1883
MQTT_TOPIC_PUB = "inclinacion_led"  # Nuevo topic para el sensor de inclinación
MQTT_TOPIC_SUB = "inclinacion_led"
